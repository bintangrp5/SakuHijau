...
public class Nas_tambah extends javax.swing.JDialog {
    ...
    private void btn_simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_simpanActionPerformed
        ...
        try (Connection conn = com.koneksi.koneksi.konek()) {
            String sql = "INSERT INTO nasabah (id, nama, alamat, no_hp, saldo) VALUES (?, ?, ?, ?, 0.0)";
            ...
            JOptionPane.showMessageDialog(this, "Kesalahan saat menyimpan: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void generateKodeNasabah() {
    try (Connection conn = com.koneksi.koneksi.konek();
         Statement st = conn.createStatement();
         ResultSet rs = st.executeQuery("SELECT id FROM nasabah ORDER BY id DESC LIMIT 1")) {

        String lastId = "NSB00000";
        if (rs.next()) {
            lastId = rs.getString("id");
        }

        int number = Integer.parseInt(lastId.substring(3)) + 1;
        String newId = String.format("NSB%05d", number);

        txt_id.setText(newId); 
        txt_id.setEditable(false); 

    } catch (SQLException e) {
        JOptionPane.showMessageDialog(this, "Gagal generate ID nasabah: " + e.getMessage());
    }
}
